...
.circle:nth-child(1) { grid-column: 5; grid-row: 11; }
.circle:nth-child(2) { grid-column: 5; grid-row: 10; }
.circle:nth-child(3) { grid-column: 5; grid-row: 9; }
.circle:nth-child(4) { grid-column: 5; grid-row: 8; }
.circle:nth-child(5) { grid-column: 5; grid-row: 7; }
.circle:nth-child(6) { grid-column: 4; grid-row: 7; }
.circle:nth-child(7) { grid-column: 3; grid-row: 7; }
.circle:nth-child(8) { grid-column: 2; grid-row: 7; }
.circle:nth-child(9) { grid-column: 1; grid-row: 7; }
.circle:nth-child(10) { grid-column: 1; grid-row: 6; }
.circle:nth-child(11) { grid-column: 1; grid-row: 5; }
.circle:nth-child(12) { grid-column: 2; grid-row: 5; }
.circle:nth-child(13) { grid-column: 3; grid-row: 5; }
.circle:nth-child(14) { grid-column: 4; grid-row: 5; }
.circle:nth-child(15) { grid-column: 5; grid-row: 5; }
.circle:nth-child(16) { grid-column: 5; grid-row: 4; }
.circle:nth-child(17) { grid-column: 5; grid-row: 3; }
.circle:nth-child(18) { grid-column: 5; grid-row: 2; }
.circle:nth-child(19) { grid-column: 5; grid-row: 1; }
.circle:nth-child(20) { grid-column: 6; grid-row: 1; }
.circle:nth-child(21) { grid-column: 7; grid-row: 1; }
.circle:nth-child(22) { grid-column: 7; grid-row: 2; }
.circle:nth-child(23) { grid-column: 7; grid-row: 3; }
.circle:nth-child(24) { grid-column: 7; grid-row: 4; }
.circle:nth-child(25) { grid-column: 7; grid-row: 5; }
.circle:nth-child(26) { grid-column: 8; grid-row: 5; }
.circle:nth-child(27) { grid-column: 9; grid-row: 5; }
.circle:nth-child(28) { grid-column: 10; grid-row: 5; }
.circle:nth-child(29) { grid-column: 11; grid-row: 5; }
.circle:nth-child(30) { grid-column: 11; grid-row: 6; }
.circle:nth-child(31) { grid-column: 11; grid-row: 7; }
.circle:nth-child(32) { grid-column: 10; grid-row: 7; }
.circle:nth-child(33) { grid-column: 9; grid-row: 7; }
.circle:nth-child(34) { grid-column: 8; grid-row: 7; }
.circle:nth-child(35) { grid-column: 7; grid-row: 7; }
.circle:nth-child(36) { grid-column: 7; grid-row: 8; }
.circle:nth-child(37) { grid-column: 7; grid-row: 9; }
.circle:nth-child(38) { grid-column: 7; grid-row: 10; }
.circle:nth-child(39) { grid-column: 7; grid-row: 11; }
.circle:nth-child(40) { grid-column: 6; grid-row: 11; }
/* Full Circles */
.circle:nth-child(41) { grid-column: 6; grid-row: 10; }
.circle:nth-child(42) { grid-column: 6; grid-row: 9; }
.circle:nth-child(43) { grid-column: 6; grid-row: 8; }
.circle:nth-child(44) { grid-column: 6; grid-row: 7; }
.circle:nth-child(45) { grid-column: 2; grid-row: 6; }
.circle:nth-child(46) { grid-column: 3; grid-row: 6; }
.circle:nth-child(47) { grid-column: 4; grid-row: 6; }
.circle:nth-child(48) { grid-column: 5; grid-row: 6; }
.circle:nth-child(49) { grid-column: 6; grid-row: 2; }
.circle:nth-child(50) { grid-column: 6; grid-row: 3; }
.circle:nth-child(51) { grid-column: 6; grid-row: 4; }
.circle:nth-child(52) { grid-column: 6; grid-row: 5; }
.circle:nth-child(53) { grid-column: 10; grid-row: 6; }
.circle:nth-child(54) { grid-column: 9; grid-row: 6; }
.circle:nth-child(55) { grid-column: 8; grid-row: 6; }
.circle:nth-child(56) { grid-column: 7; grid-row: 6; }
.circle:nth-child(57) { grid-column: 2; grid-row: 11; }
.circle:nth-child(58) { grid-column: 1; grid-row: 11; }
/* Home Circles */
.circle:nth-child(59) { grid-column: 2; grid-row: 10; }
.circle:nth-child(60) { grid-column: 1; grid-row: 10; }
.circle:nth-child(61) { grid-column: 2; grid-row: 2; }
.circle:nth-child(62) { grid-column: 1; grid-row: 2; }
.circle:nth-child(63) { grid-column: 2; grid-row: 1; }
.circle:nth-child(64) { grid-column: 1; grid-row: 1; }
.circle:nth-child(65) { grid-column: 11; grid-row: 2; }
.circle:nth-child(66) { grid-column: 10; grid-row: 2; }
.circle:nth-child(67) { grid-column: 11; grid-row: 1; }
.circle:nth-child(68) { grid-column: 10; grid-row: 1; }
.circle:nth-child(69) { grid-column: 11; grid-row: 10; }
.circle:nth-child(70) { grid-column: 10; grid-row: 10; }
.circle:nth-child(71) { grid-column: 11; grid-row: 11; }
.circle:nth-child(72) { grid-column: 10; grid-row: 11; }
